...
test_that("batch_seeds", {
  ...
  expect_identical(
    batch_seeds("y"),
    list(y = c(
      10407L, -1566460856L, -211444225L, 1832649274L, 765616827L,
  ...
  expect_identical(
    batch_seeds(c("aa", "b")),
    list("aa" = c(
      10407L, 1297212536L, 1045826670L, -1779609075L, 1968341300L,
      -1710900677L, -1193063059L
    ), "b" = c(
      10407L, -523009245L, 2009368735L,
